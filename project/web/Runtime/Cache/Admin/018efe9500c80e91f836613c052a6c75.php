...
<body>
  <?php  var_dump($_SESSION); $AUTH = new \Think\Auth(); $aaa = $AUTH->getGroups(session('adminid')); ?>
    <div id="wrapper">
            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <form action="<?php echo U('Admin/Thinkauthgroup/index');?>" method="get">
                ...
                <div class="row">
                  ...
                  <!-- 权限组列表遍历 -->
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      ...
                      <tbody>
                        <?php if(is_array($group)): foreach($group as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="title"><?php echo ($vo["rules"]); ?></td>
                              ...
                              <?php  if($_SESSION['adminname'] == 'admin'){ ?> 
                                ...
                                <a href="<?php echo U('Admin/Thinkauthgroup/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list"></i></a>
                              </td>   
                             <?php  }else{ ?> 
                                  <td class="center">
  ...
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Thinkauthgroup/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
