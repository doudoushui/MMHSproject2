...
<body>
                ...
                <div class="sidebar-nav navbar-collapse">
                  ...
                  <!-- 权限组 -->
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Admin/Thinkauthgroupaccess/index');?>">权限组列表</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Admin/Thinkauthgroupaccess/add');?>">权限组添加</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <form action="<?php echo U('Admin/Thinkauthgroupaccess/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>权限组名:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 80px;" aria-label="Browser: activate to sort column ascending">权限组名[title]</th>
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 100px;" aria-label="Browser: activate to sort column ascending">所有规则权限[rules]</th>
                       
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 60px;" aria-label="Platform(s): activate to sort column ascending">管理员id[uid]</th>
  ...
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Thinkauthgroupaccess/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
