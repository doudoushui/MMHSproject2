      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>订单编号:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
            ...
            <!-- class="hidden" -->
            <?php if($vo['ostate'] == 0): ?>
            <a href="<?php echo U('Admin/Order/update',array('id'=>$vo['id'],'ostate'=>1));?>" class="btn btn-primary">发货</a>
            <a href="<?php echo U('Admin/Order/update',array('id'=>$vo['id'],'ostate'=>3));?>" class="btn btn-danger">失效订单</a></td>
            <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if($vo['ostate'] == 3): ?>
            <a href="<?php echo U('Admin/Order/update',array('id'=>$vo['id'],'ostate'=>3));?>" class="btn btn-danger">已失效订单</a></td>
            <?php endif; ?>
                            </td>
  ...
  <script type="text/javascript">
   $('.edit').dblclick(function(){
    ...
    inp.blur(function(){
      ...
      // 发送ajax
      $.post("<?php echo U('Admin/Order/momo');?>",{id:id,oname:newV},function(data){
        if(data == 1){
          td.html(newV);
        }else{
          alert('修改失败');
