            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <form action="<?php echo U('Admin/Sug/index');?>" method="get">
                ...
                <div class="row">
                  ...
                  <!-- 订单列表遍历 -->
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1"  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">信息生成时间</th>
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" style="width:600px" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">信息</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php if(is_array($sugs)): foreach($sugs as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sorting_1 sid"><?php echo ($vo["stime"]); ?></td>
                            
                            <td><?php echo ($vo["username"]); ?></td>
                            <td>
                             <?php echo htmlspecialchars_decode($vo['smsg']); ?>
                            </td>
