      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
           <div class="row">
           <div class="col-lg-6">
               <form role="form" action="<?php echo U('Admin/Resume/update');?>" method="post" enctype="multipart/form-data">
          
               <input type="hidden" name="rid" value="<?php echo $_GET['id'];?>">
                  <!-- <div class="form-group">
                       <label> 岗位名 :</label><br><br>
                       <input name="resume_wid" value="<?php echo ($info["resume_wid"]); ?>" placeholder="请输入要应聘的岗位的ID" class="form-control">
                   </div> -->

                   <div class="form-group">
                       <label> 姓名 :</label><br><br>
                       <input name="resume_name" value="<?php echo ($info["resume_name"]); ?>" placeholder="请输入你的姓名" class="form-control">
                   </div>
                   
                   <div class="form-group">
                       <label> 性别 :</label><br><br>
                       <label class="radio-inline">
                           <input type="radio" <?php if($info['sex'] == 1): ?>checked<?php endif; ?> value="1" id="optionsRadiosInline1" name="resume_sex">男
                       </label>
                       <label class="radio-inline">
                           <input type="radio" value="0" <?php if($info['sex'] == 0): ?>checked<?php endif; ?> id="optionsRadiosInline2" name="resume_sex">女
                       </label>
                       <label class="radio-inline">
                           <input type="radio" value="2" <?php if($info['sex'] == 2): ?>checked<?php endif; ?> id="optionsRadiosInline3" name="resume_sex">保密
                       </label>
                   </div>
                    <!--js年月日选择-->
                    <div class="form-group">
                       ...
                       <div class="form-group" style="width:100%;height:70px;">
                          <p class="datep"><input class="datainp form-control" id="datebut" type="text" placeholder="  请选择" name="resume_birth" value="<?php echo ($info["resume_birth"]); ?>">
                   ...
                   <div class="form-group">
                       ...
                       <div class="form-group" style="width:100%;height:35px;">
                        <input type="text" id="city" name="resume_address" value="<?php echo ($info["resume_address"]); ?>" placeholder="点此选择所在城市" class="form-control" />
                       </div>
                   ...
                   <div class="form-group">
                    ...
                    <img src="<?php echo ($info["resume_pic"]); ?>" width="100px;">
                   </div>
                   <div class="form-group">
                    <label> 手机号 :</label><br><br>
                    <input type="text" name="resume_phone" value="<?php echo ($info["resume_phone"]); ?>" placeholder="请输入手机号" class="form-control">
                   </div>
    
                   <div class="form-group">
                    <label> 邮箱 :</label><br><br>
                    <input type="text" name="resume_email" value="<?php echo ($info["resume_email"]); ?>" placeholder="请输入合法邮箱账号" class="form-control">
                   </div>

                   <div class="form-group">
                    <label> 个人简介 :</label><br><br>
                    <textarea name="resume_intro" rows="3" class="form-control" value="" placeholder="输入你的工作经历及个人点评"><?php echo ($info["resume_intro"]); ?></textarea>
                   </div>
