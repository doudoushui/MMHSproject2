      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
               <div class="row">
                   <div class="col-lg-6">
                       <form role="form" action="<?php echo U('Admin/Job/insert');?>" method="post" enctype="multipart/form-data">
                           
                           <div class="form-group">
                               <label>岗位名</label>
                               <input name="work" placeholder="请输入要招聘岗位名称" class="form-control">
                           </div>

                           <div class="form-group">
                               <label>招聘人数</label>
                               <input type="text" name="personnum" placeholder="请输入该岗位要招聘的人数" class="form-control">
                           </div>
                           <div class="form-group">
                               <label>人事联系电话</label>
                               <input type="text" name="job_phone" placeholder="请输入电话号码" class="form-control">
                           </div>

                           <div class="form-group">
                               <label>人事邮箱</label>
                               <input type="text" name="job_email" placeholder="请输入合法邮箱账号" class="form-control">
                           </div>
                           <!-- <div class="form-group">
                               <label>上传头像</label>
                            ...
                            <div class="form-group">
                               <label>工作地点</label>
                                <input type="text" name="job_address" placeholder="请输入工作地点" class="form-control">
                           </div>

                            <div class="form-group">
                               <label>职位简介及职位要求</label>
                               <textarea name="job_intro" rows="3" placeholder="请输入职位简介及职位要求" class="form-control"></textarea>
                           </div>
                           <div class="form-group">
                               <label>职位信息及要求</label>
                               <script id="editor" name="jinfo" type="text/plain" style="width:1080px;height:500px;">
                               </script>
                           </div>
