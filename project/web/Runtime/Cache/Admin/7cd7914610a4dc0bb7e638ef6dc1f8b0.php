                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      ...
                      <tbody>
                        <?php if(is_array($cates)): foreach($cates as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="center">
                              <!-- <a href="Admin/Cate/del/id/<?php echo ($vo['id']); ?>/pid/<?php echo ($vo['pid']); ?>"class="btn btn-danger "><span class="glyphicon glyphicon-trash"> 删除</span></a> -->
                              <a href="<?php echo U('Admin/Cate/del', array('id'=>$vo['id'],'pid'=>$vo['pid']));?>"class="btn btn-danger "><span class="glyphicon glyphicon-trash"> 删除</span></a>
