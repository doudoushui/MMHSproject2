       ...
       <div class="col-lg-12">
           <div class="panel panel-default">
               ...
               <div class="panel-body">
                   <div class="row">
                       <div class="col-lg-6">
                           <form role="form" action="<?php echo U('Admin/Thinkauthrule/insert');?>" method="post" enctype="multipart/form-data">
                               
                               <div class="form-group">
                                   <label>路径形式</label><br>
                                   &nbsp;&nbsp;<b style="color:#0aa">模块名/控制器/方法名</b><br>
                                   <span>例如: Admin/Index/index   后台首页</span>                                  
                               </div>

                               <div class="form-group">
                                   <label>权限路径</label>
                                   <input name="name" placeholder="请按照模块/控制器/方法格式填写" class="form-control">
                               </div>

                                <div class="form-group">
                                   <label>权限组名</label>
                                   <input name="title" placeholder="请输入权限组名" class="form-control">
                               </div>
