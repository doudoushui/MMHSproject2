        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-6">
              ...
              <form role="form" action="<?php echo U('Admin/Goods/update');?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                <input type="hidden" name="cate_id" value="<?php echo ($info["cate_id"]); ?>">
                <input type="hidden" name="gtime" value="<?php echo ($info["gtime"]); ?>">
                  <div class="form-group">
                    <label>商品名</label>
                    <input value="<?php echo ($info["gname"]); ?>" name="gname" placeholder="" class="form-control">
                  </div>
                  <div class="form-group">
                      <label>商品图片</label>
                      <input name="gpic" type="file">
                        <img src="<?php echo ($info["gpic"]); ?>" width="100px">
                  </div>
                      
                  <div class="form-group">
                    <label>价格</label>
                    <input value="<?php echo ($info["price"]); ?>" name="price" placeholder="" class="form-control">
                        
                  </div>
                  <div class="form-group">
                    <label>商品库存</label>
                    <input value="<?php echo ($info["stock"]); ?>" name="stock" placeholder="" class="form-control">
                        
                  </div>
                  <div class="form-group">
                      <label>商品描述</label>
                      <textarea name="msg" rows="3" class="form-control"><?php echo ($info["msg"]); ?></textarea>
                  </div>
