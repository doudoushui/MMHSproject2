...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">商品评论信息添加</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
               <div class="row">
                   <div class="col-lg-6">
                       <form role="form" action="<?php echo U('Admin/Goodscomment/insert');?>" method="post" enctype="multipart/form-data">
                           <div class="form-group">
                               <label>用户ID</label>
                               <input name="user_id" placeholder="请输入评论该商品的用户名" class="form-control">
                           </div>

                           <div class="form-group">
                               <label>商品ID</label>
                               <input name="goods_id" placeholder="请输入要评论的商品ID" class="form-control">
                           </div>

                           <div class="form-group">
                               <label>商品名</label>
                               <input name="gname" placeholder="请输入要评论的商品名" class="form-control">
                           </div>
                           ...
                           <div class="form-group">
                               <label>评论信息栏</label>
                               <script id="editor" name="commsg" type="text/plain" style="width:auto;height:500px;">
                               </script>
                           </div>
