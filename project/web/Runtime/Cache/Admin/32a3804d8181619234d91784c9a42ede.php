                ...
                <form action="<?php echo U('Admin/Job/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label style="margin-left:200px;">岗位名称:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                  ...
                  <!--循环遍历-->
                  <?php if(is_array($jobs)): foreach($jobs as $k=>$vo): ?><div class="row">
                    <div class="col-sm-12">
                    <!-- 用户列表遍历 -->
                      <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                        ...
                        <tbody>
                          <tr class="gradeA odd" role="row">
                            ...
                            <td><?php echo ($vo["jtime"]); ?></td>
                            <td class="edit"><?php echo ($vo["work"]); ?></td>
                            <td class="editn"><?php echo ($vo["personnum"]); ?></td>
                            <td class="editp"><?php echo ($vo["job_phone"]); ?></td>
                            <td class="edite"><?php echo ($vo["job_email"]); ?></td>
                            <td class="editi"><?php echo ($vo["job_intro"]); ?></td>
                            <td class="edita"><?php echo ($vo["job_address"]); ?></td>
                            <td class="center">
                              <button class="btn btn-danger btn-del " type="button"><i class="fa fa-times">&nbsp;删除&nbsp;</i></button><br><br>                  
                              <a href="<?php echo U('Admin/Job/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list">&nbsp;编辑&nbsp;</i></a>
                            </td>
                          </tr>
