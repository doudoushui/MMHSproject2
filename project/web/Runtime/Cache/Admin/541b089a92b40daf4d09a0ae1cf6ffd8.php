                ...
                <form action="<?php echo U('Admin/Fashion/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label style="margin-left:200px;">标题名称:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                  ...
                  <!--循环遍历-->
                  <?php if(is_array($fashions)): foreach($fashions as $k=>$vo): ?><div class="row">
                    <div class="col-sm-12">
                    <!-- 用户列表遍历 -->
                        <thead class="tid">
                          <tr role="row">
                        ...
                        <tbody>
                          <tr class="gradeA odd" role="row">
                            ...
                            <td>
                              <img src="<?php echo ($vo["fpic"]); ?>" width="150px">
                            </td>
                            <td class="ftitle"><?php echo ($vo["title"]); ?></td>
                            <td class="fpub"><?php echo ($vo["publisher"]); ?></td>
                            <td><?php echo ($vo["ftime"]); ?></td>
                            <td class="ftitle"><?php echo ($vo["authorintro"]); ?></td>

                           
                            <td class="center">
                              <button class="btn btn-danger btn-del " type="button"><i class="fa fa-times">&nbsp;删除&nbsp;</i></button><br><br>                  
                              <a href="<?php echo U('Admin/Fashion/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list">&nbsp;编辑&nbsp;</i></a>
                            </td>
                          </tr>
                          <tr>
  ...
  <script type="text/javascript">
    ...
    $('.fpub').dblclick(function(){
      ...
      inp.blur(function(){
        ...
        //获取当前的id
        var id = $(this).parents('tr').find('.sid').html();
        var url = "<?php echo U('Admin/Fashion/ajaxeditfpub');?>";
        var btn = $(this);
        //ajax
    ...
    $('.ftitle').dblclick(function(){
      ...
      inp.blur(function(){
        ...
        //获取当前的id
        var id = $(this).parents('tr').find('.sid').html();
        var url = "<?php echo U('Admin/Fashion/ajaxeditftitle');?>";
        var btn = $(this);
        //ajax
