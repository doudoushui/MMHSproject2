   ...
   <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
       <div class="row">
         <div class="col-lg-6">
          <form role="form" action="<?php echo U('Admin/Goods/edit_img');?>" method="post" enctype="multipart/form-data">
           <!-- <input type="hidden" name="id"> -->
           <input type="hidden" name="goods_id" value="<?php echo ($info["id"]); ?>">
           <!-- <input type="hidden" name="goods_id" value="<?php echo $goods_id ?>"> -->
            
            <div class="form-group">
              <label>您正在管理的商品名是:<?php echo ($info["gname"]); ?></label>
              <p></p>
            </div>
             <div class="form-group">
              <label>您正在管理的商品ID是:<?php echo ($info["id"]); ?></label>
              <p></p>
            </div>
            <div class="form-group">
              <label>商品小图1</label>
           ...
           <button class="btn btn-info" type="submit">点击添加图片呦~~</button>
          </form>
        </div>
      <!--  <div class="form-group">
         <table>            
          <?php if(is_array($image)): foreach($image as $k=>$vo): ?><tr class="gradeA odd" role="row">
                <td class="sorting_1 sid"><?php echo ($vo["id"]); ?></td>
              <td class="sorting_1">
                  <img src="<?php echo ($vo["iname"]); ?>" width="200px">
                 </td>
                 <td class="center">
      ...
      <div class="form-group">
         <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info"> 
          ...
          <?php if(is_array($image)): foreach($image as $k=>$vo): ?><tr class="gradeA odd" role="row">
              <td class="sorting_1 sid"><?php echo ($vo["id"]); ?></td> 
              <td class="sorting_1">
                  <img src="<?php echo ($vo["iname"]); ?>" width="80px">
              </td>
...
<script type="text/javascript" src="/Public/Admin/js/jquery-1.8.3.min.js"></script>
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Goods/img_del');?>";
      // alert(url);
      var btn = $(this);
      //ajax
