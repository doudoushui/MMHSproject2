...
<body>
  <?php  ?>
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">商品评论信息列表</h1>
      </div>
      <!-- /.col-lg-12 -->
    </div>
    <div class="row">
            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <form action="<?php echo U('Admin/Goodscomment/index');?>" method="get">
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th tabindex="0" rowspan="1" colspan="1" style="width:30px;">用户ID</th>
                          <th rowspan="1" colspan="1" style="width:30px;">商品ID</th>
                          <th rowspan="1" colspan="1" style="width:90px;">商品名</th>
                          <th rowspan="1" colspan="1" style="width:90px;">商品图片</th>
                          <th rowspan="1" colspan="1" style="width:200px;">评论信息</th>
                          <th rowspan="1" colspan="1" style="width:90px;">评论时间</th>
                          <th rowspan="1" colspan="1" style="width: 90px;">操作</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php if(is_array($goodscomments)): foreach($goodscomments as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sid"><?php echo ($vo["id"]); ?></td>
                            <td><?php echo ($vo["user_id"]); ?></td>
                            <td><?php echo ($vo["goods_id"]); ?></td>
                            <td class="edit"><?php echo ($vo["gname"]); ?></td>
                            <td>
                              <img src="<?php echo ($vo["gpic"]); ?>" width="100px">
                            </td>
                            <td><?php echo htmlspecialchars_decode($vo['commsg']); ?></td>
                            <td><?php echo ($vo["comtime"]); ?></td>
                            <!-- <td class="sorting_1">
                              <img src="<?php echo ($vo["r_pic"]); ?>" width="50px">
                            </td> -->
                            <td class="center">
                              <button class="btn btn-danger btn-del " type="button"><i class="fa fa-times">&nbsp;删除&nbsp;</i></button><br><br>                         
                              <a href="<?php echo U('Admin/Goodscomment/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list">&nbsp;编辑&nbsp;</i></a>
                            </td>
 ...
 <script type="text/javascript" src="/Public/Admin/js/jquery-1.8.3.min.js"></script>
  <script type="text/javascript">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Goodscomment/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
    ...
    $('.edit').dblclick(function(){
      ...
      inp.blur(function(){
        ...
        //获取当前的id
        var id = $(this).parents('tr').find('.sid').html();
        var url = "<?php echo U('Admin/Goodscomment/ajaxedit');?>";
        var btn = $(this);
        //ajax
        $.post(url,{id:id,gname:newV},function(data){
        if (data == 1) {
         td.html(newV);
        }else{
          alert('修改失败');
