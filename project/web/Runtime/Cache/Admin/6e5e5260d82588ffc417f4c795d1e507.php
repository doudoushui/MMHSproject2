       ...
       <div class="row">
         <div class="col-lg-6">
          <form role="form" action="<?php echo U('Admin/Goods/insert');?>" method="post" enctype="multipart/form-data">
           <input type="hidden" name="gtime">
           <!-- <input type="hidden" name="cate_id" value="cid"> -->
            <div class="form-group">
              <label>所属分类列表</label>
              <select name="cate_id" class="form-control">
                <?php if(is_array($cates)): foreach($cates as $k=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($v["id"] == $info['pid'] ): ?>selected<?php endif; ?> ><?php echo ($v["cname"]); ?></option><?php endforeach; endif; ?>
              </select>
            ...
            <div class="form-group">
              <label>商品名</label>
              <input name="gname"  class="form-control">
            </div>
            <div class="form-group">
              <label>商品图片</label>
