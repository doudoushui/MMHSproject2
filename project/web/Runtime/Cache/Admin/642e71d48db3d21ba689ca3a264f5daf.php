       ...
       <div class="col-lg-12">
           <div class="panel panel-default">
               ...
               <div class="panel-body">
                   <div class="row">
                       <div class="col-lg-6">
                           <form role="form" action="<?php echo U('Admin/Thinkauthgroup/insert');?>" method="post" enctype="multipart/form-data">
                               
                              <div class="form-group">
                                   <label>权限组名</label>
                                   <input name="title" placeholder="请填写权限组名" class="form-control">
                               </div>

                               <div class="form-group">
                                   <label>权限规则id</label><br>
                                   &nbsp;&nbsp;<b style="color:#0aa">规则id用逗号连接</b><br>
                                   <span>例如: 1,2,3  </span>                                  
                               </div>

                                <div class="form-group">
                                   <label>权限规则id</label>
                                   <input name="rules" placeholder="请输入权限规则id" class="form-control">
                               </div>
