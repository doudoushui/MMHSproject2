               ...
               <div class="row">
                   <div class="col-lg-6">
                       <form role="form" action="<?php echo U('Admin/Fashion/update');?>" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                               <label>发布者</label>
                               <input name="publisher" value="<?php echo ($info["publisher"]); ?>" placeholder="请输入发布者" class="form-control">
                           </div>
                            <div class="form-group">
                               <label>发布者简介</label>
                               <input name="authorintro" value="<?php echo ($info["authorintro"]); ?>" placeholder="请输入发布者简介" class="form-control">
                           </div>
                           ...
                           <div class="form-group">
                            ...
                            <script id="editor" name="fmsg" type="text/plain" style="width:800px;height:500px;"><?php echo ($res); ?>
                            </script>
                           </div>
