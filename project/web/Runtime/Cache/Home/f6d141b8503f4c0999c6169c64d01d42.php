...
<div class="container">
  <div class="row">
    <h1 style="color:#f46;">购物车 <small><b>看看我的宝贝呦</small></b></h1>
  </div>
  <div class="row">
      <table class="table">
          <tr>
          ...
          <tr>
            <td>
              <a href="">
                <img src="<?php echo ($val["gpic"]); ?>" style="width:80px;height:80px;">
              </a>
            </td>

            <td ><a href=""><?php echo ($val["gname"]); ?></a></td>
            <!-- <td ><a href=""><?php echo ($val["goods_id"]); ?></a></td> -->
            <td><?php echo ($val["price"]); ?></td>
            <td>
              <!-- <a href="<?php echo U('Home/Cart/jian',array('goods_id'=>$val['goods_id']));?>?qty=<?php echo ($val['qty']); ?>"><span class="glyphicon glyphicon-minus"></span></a> -->
              <!-- <a href="<?php echo U('Home/Cart/jian',array('goods_id'=>$val['goods_id'],'qty'=>$val['qty']));?>"><span class="glyphicon glyphicon-minus"></span></a> -->
              <a href="jian/goods_id/<?php echo ($val['goods_id']); ?>/qty/<?php echo ($val['qty']); ?>"><span class="glyphicon glyphicon-minus"></span></a>
              [ <?php echo ($val["qty"]); ?> ]

              <a href="jia/goods_id/<?php echo ($val['goods_id']); ?>/qty/<?php echo ($val['qty']); ?>"><span class="glyphicon glyphicon-plus"></span></a>
            </td>
            <td> <?php echo ($val['price'] *$val['qty']); ?> </td>
            <td>
              <a href="<?php echo U('Home/Cart/del',array('goods_id'=>$val['goods_id']));?>"class="btn btn-danger btn-del"><span class="glyphicon glyphicon-trash"> 删除</span></a></td>
            </tr>
            <?php $total += $val['price'] *$val['qty'];?>
            <?php endforeach ?>
          <tr>
            <td colspan="6" class="text-right">
              <a href="<?php echo U('Home/Goods/index');?>"class="btn btn-info"><span class="glyphicon glyphicon-briefcase"style="height:30px;width:120px;"> 继续购物</span></a>
              <a href="<?php echo U('Home/Cart/delall',array('goods_id'=>$val['goods_id']));?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"style="height:30px;width:120px;"> 清空购物车</span></a>
              <a href="<?php echo U('Home/Cart/index');?>" class="btn btn-warning"><span class="glyphicon glyphicon-shopping-cart"style="height:30px;width:120px;"> 总计:<?php echo $total; ?></span></a>
              <a href="<?php echo U('Home/Orderby/index');?>" class="btn btn-primary"><span class="glyphicon glyphicon-send"style="height:30px;width:120px;"> 去结算</span></a>
            </td>
          </tr>
        </table>
    </div>
