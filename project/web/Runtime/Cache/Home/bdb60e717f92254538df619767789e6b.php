...
.mt40{margin-top:30px;}
  ...
  <div class="container" style="margin-top:10px;">
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="/Public/Uploads/Recommend/1.jpg" height="200px;">
          </div>
          <div class="item">
            <img src="/Public/Uploads/Recommend/2.jpg" height="200px;">
          </div>
          <div class="item">
            <img src="/Public/Uploads/Recommend/3.jpg" height="200px;">
          </div>
        </div>
        <!-- Controls -->
      ...
      <!-- <div id="slider-container">
		...
		<ul>
			<li>
				<a href="<?php echo U('Home/Recommend/index');?>"><img src="/Public/Home/Jlb/images/index1.jpg" alt="" /></a>
			...
			<li>
				<a href="<?php echo U('Home/Recommend/index');?>"><img src="/Public/Home/Jlb/images/index2.jpg"alt="" /></a>
				<div class="label_text">
					<h3 class="colortext uppercase">帮你展现更美的自已
					</h3>
			...
			<li>
				<a href="<?php echo U('Home/Recommend/index');?>"><img src="/Public/Home/Jlb/images/index3.jpg" alt="" /></a>
				<div class="label_text">
					<h3 class="colortext uppercase">帮你展现更美的自已
					</h3>
        ...
        <!-- <div class="row" style="margin-top:10px;">
          <?php if(is_array($Recommends)): foreach($Recommends as $k=>$vo): ?><div class="col-sm-6 col-md-3">
              <div class="thumbnail">
                <!-- <img src="holder.js/242x200" alt="..."> 
                <div class="caption">
                  <h3 style="line-height:35px"><?php echo ($vo["work"]); ?></h3>
                  <p><?php echo ($vo["Recommend_intro"]); ?></p>
                  <p>
                    <a href="<?php echo U('Home/Recommend/intro');?>" class="btn btn-primary" role="button">岗位详情</a><br><br>
                    <a href="<?php echo U('Home/Recommend/sent');?>" class="btn btn-default" role="button">填写简历</a>
                  </p>
                </div>
              </div>
	...
	<div style="width: 1080px;height:auto;margin: 0 auto;">
		<li id="item" style="display:none; margin-top:10px; margin-left:130px; width: 200px;height: 320px;border:solid 1px #ccc;padding: 10px;text-align:center;">
		  ...
		  <p>&nbsp;&nbsp;
	       <a href="<?php echo U('Home/Recommend/r_msg');?>" class="btn btn-primary" role="button" >公司详情</a><br><br>
	       <!-- <a href="<?php echo U('Home/Recommend/sent');?>" class="btn btn-default" role="button">填写简历</a> -->
	      </p>
		</li>
		<div id="ul">
  ...
  <script type="text/javascript">
	...
	var p = 1;//页码信息
	var isLoading = false;
	var url = "<?php echo U('Home/Recommend/ajax');?>";
