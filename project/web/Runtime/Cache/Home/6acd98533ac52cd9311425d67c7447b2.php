...
.mt40{margin-top:30px;}
  ...
  <div class="container" style="margin-top:10px;">
	...
	<!-- <div class="row">
    <form action="<?php echo U('Home/Job/index');?>" method="get">
      <div class="col-sm-12">
        <div id="dataTables-example_filter" class="dataTables_filter">
        <br>	
          <label style="margin-left:880px;">岗位名称:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
