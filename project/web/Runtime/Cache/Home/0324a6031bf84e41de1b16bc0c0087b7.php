...
<style type="text/css">
  ...
  <div style="width:250px;float:left">
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px"><span style="margin-left:10px;font-size:20px;color:#ccc"><a href="<?php echo U('Home/Personal/index');?>" style="padding:10px 150px 7px 7px">个人中心</a></span></div>
     ...
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Personal/information');?>" style="padding:10px 150px 7px 7px">个人资料</a></span></div>
       ...
       <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Orderby/index');?>" style="padding:10px 130px 7px 7px">未完成订单</a></span></div>
	     ...
	     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px;color:#ccc">已收货订单</span></div>
  ...
  <div style="width:700px;float:right;border:1px solid #ccc">
    <form action="<?php echo U('Home/Order/delivered');?>" method="get">
              ...
              <div style="float:right">
                <label>订单编号:<input value="<?php echo ($_GET['keyword']); ?>" name="keyword" type="search" placeholder=""></label>
	       ...
	       <div style="width:700px;float:right;border:1px solid #ccc">
	          ...
	          <!-- 订单列表遍历 -->
	            <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
	              ...
	              <tbody>
	                <?php if(is_array($orders)): foreach($orders as $k=>$vo): ?><tr class="gradeA odd" role="row">
	                    <td class="sorting_1"><?php echo ($vo["ordertime"]); ?></td>
	                    
	                    <td><?php echo ($vo["ordernum"]); ?></td>
	                    <td>
	                      <img src="<?php echo ($vo["gpic"]); ?>" width="40px" height="30px">
	                    </td>
	                    ...
	                    <td class="center">
	                    <?php switch ($vo[ostate]) { case 0: echo '未发货'; break; case 1: echo '已发货'; break; case 2: echo '已签收'; break; case 3: echo '订单已失效'; break; }?></td>
	    <td>	

	    <!-- class="hidden" -->
	    <?php if($vo['ostate'] == 0): ?>
      <a href="<?php echo U('Home/Order/update',array('id'=>$vo['id'],'ostate'=>3));?>" class="btn btn-danger" style="width:70px">退货退款</a></td>
      <?php endif; ?>
      
      <?php if($vo['ostate'] == 1): ?>
      <a href="<?php echo U('Home/Order/update',array('id'=>$vo['id'],'ostate'=>2));?>" class="btn btn-success" style="width:70px">确认收货</a>
      <a href="<?php echo U('Home/Order/update',array('id'=>$vo['id'],'ostate'=>3));?>" class="btn btn-danger" style="width:70px">申请退款</a></td>
      <?php endif; ?>
      
      <?php if($vo['ostate'] == 2): ?>
      <a href="<?php echo U('Home/Order/update',array('id'=>$vo['id'],'ostate'=>3));?>" class="btn btn-danger" style="width:70px">售后服务</a>
      <a href="<?php echo U('Home/Order/update');?>" class="btn btn-outline btn-default" style="width:70px">立即评价</a></td>
      <?php endif; ?>
      <?php if($vo['ostate'] == 3): ?>
      <button class="btn btn-danger" disabled>已失效订单</button></td>
      <?php endif; ?>
	                    </td>
