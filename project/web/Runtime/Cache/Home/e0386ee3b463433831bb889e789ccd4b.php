...
<div style="width:80%;margin:20px auto;height:800px;">
  <div style="width:250px;float:left">
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Feedback/index');?>" style="text-decoration:none;padding:10px 150px 7px 7px">客户点评</a></span></div>
                             ...
                             <form role="form" action="<?php echo U('Home/Feedback/insert');?>" method="post" enctype="multipart/form-data">
                                 ...
                                 <input type="hidden">
                                  <div class="form-group">
                                     <label>反馈信息</label>
                                    <script id="editor" name="smsg" type="text/plain" style="width:660px;height:500px;"></script>
