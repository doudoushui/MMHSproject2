        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon-hand-right" aria-hidden="true"></span>&nbsp;&nbsp;关于我们 <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="<?php echo U('Home/');?>">招聘管理</a></li>
                <!-- <li><a href="#">婚庆推荐</a></li> -->
               
                <li role="separator" class="divider"></li>
                <li><a href="<?php echo U('Home/');?>">优秀婚庆推荐</a></li>
              </ul>
            </li>
...
<div style="width:80%;margin:20px auto;height:800px;">
  <div style="width:250px;float:left">
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px"><span style="margin-left:10px;font-size:20px" ><a href="<?php echo U('Home/Personal/index');?> style="padding:10px 150px 7px 7px"">个人中心</a></span></div><div style="width:250px;height:278px;margin-top:20px;border:1px solid #ccc">
     ...
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px;color:#ccc">个人资料</span></div>
       ...
       <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Orderaddress/index');?>" style="padding:10px 150px 7px 7px">收货地址</a></span></div>
   ...
   <div style="width:700px;float:right;border:1px solid #ccc">
      ...
      <form class="form-horizontal" action="<?php echo U('Home/Personal/update');?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
          <input type="hidden" name="id" value="<?php echo ($xj["id"]); ?>">
            <label class="col-sm-2 control-label">用户名</label>
            <div class="col-sm-10">
              <input type="email" name="username" class="form-control" value="<?php echo ($xj["username"]); ?>" disabled>
            </div>
          </div>
          <div class="form-group">
          <label class="col-sm-2 control-label">上传头像</label>
               ...
               <div class="col-sm-10">
                 <?php  if(empty($xj[pic])){ echo '<img src="/Public/Home/Images/touxiang.jpg" width="50px" height="50px">'; }else{ echo '<img src="'.$xj[pic].'" width="50px" height="50px">'; } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <input type="radio" name="sex" value=2 <?php if($info["sex"] == 2): ?>checked<?php endif; ?> >不详
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">爱好</label>
            <div class="col-sm-10">
              <input type="checkbox" name="hobby[]" value="0" <?php if(in_array('0',$hobby) ): ?>checked<?php endif; ?> >篮球
              <input type="checkbox" name="hobby[]" value="1" <?php if(in_array('1',$hobby) ): ?>checked<?php endif; ?> >足球
              <input type="checkbox" name="hobby[]" value="2" <?php if(in_array('2',$hobby) ): ?>checked<?php endif; ?> >球球
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">手机号</label>
            <div class="col-sm-10">
              <input type="text" name="tel" class="form-control" value="<?php echo ($xj["tel"]); ?>" >
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">邮箱</label>
            <div class="col-sm-10">
              <input type="text" name="email" class="form-control" value="<?php echo ($xj["email"]); ?>" >
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">个人简介</label>
            <div class="col-sm-10">
              <textarea name="intro" class="form-control"><?php echo ($xj["intro"]); ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              ...
              <a class="btn btn-default" href="<?php echo U('Home/Personal/information');?>" role="button" style="color:#000">关闭</a>
            </div>
          </div>
      </form>
