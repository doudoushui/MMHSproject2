...
<div style="width:80%;margin:20px auto">
  <div style="width:250px;float:left">
     ...
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Feedback/add');?>" style="padding:10px 110px 7px 7px">填写反馈信息</a></span></div>
