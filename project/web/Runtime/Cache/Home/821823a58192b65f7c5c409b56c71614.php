...
<div class="" style="width:100%;height:60px;background:pink; border:1px solid white;">
  <?php if(is_array($cates)): foreach($cates as $k=>$vo): ?>&nbsp;<a href="<?php echo U('Home/Cate/index',array('cate_id'=>$vo['id']));?>" style="font-size:14px;line-height:60px;"><?php echo ($vo["cname"]); ?></a>&nbsp;<?php endforeach; endif; ?>
</div>
    <div style="width:100%;height:50px;margin-top:5px;">
      <form action="<?php echo U('Home/Goods/search');?>" role="search" method="get" >
        <input  type="search" style="width:400px;height:50px;margin-left:360px;" placeholder="搜索一下呦!" name="keyword">
       <button class="btn btn-default" style="width:100px;height:50px;background:#f46;" type="submit">搜索</button>
  ...
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="margin-top:60px;">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <center><img src="/Public/Home/Picture/2.jpg" alt="..."></center>
      ...
      <!-- <div class="row" >  -->
      <!--   <?php if(is_array($goods)): foreach($goods as $k=>$vo): ?><div class="col-sm-6 col-md-3" style="">
            <div class="thumbnail">
              <img src="<?php echo ($vo["gpic"]); ?>" alt="..."style="width:100%;">
...
<div style="width: 100%;height:auto;margin: 0 auto;">
  ...
  var p = 1;//页码信息
  var isLoading = false;
  var url = "<?php echo U('Home/Goods/ajax');?>";
  requestGoods();
  // console.log(p);
    //封装函数发起请求
