...
<div class="jumbotron" style="height:800px;background-image:url('/Public/Home/Images/register.jpg');background-repeat:no-repeat;background-size:cover;" >
  <h4 style="color:#0ef">
...
<h4>红荷张开并蒂花，朝阳彩凤喜迎门，<br><br>贺客满门庆新婚，红烛高照结姻缘，百年好合琴瑟鼓，<br><br>鸾风和鸣情意浓，祝愿爱挽君心玉人心，情系君身玉人身，新婚快乐<br></h4>
  <!-- <image src="/Public/Home/login.jpg"></image> -->
     <button type="button" style="color:#0ef;background:#38f;border-radius:50%;" class="btn  btn-lg" data-toggle="modal" data-target="#myModal">
          快来注册哦~~
     </button>
            ...
            <div class="modal-body">
              <form role="form" method="post" action="<?php echo U('Home/Register/register');?>">
                  <fieldset>
                      ...
                      <div class="form-group">
                        <label>邮箱</label>
                        <input class="form-control" placeholder="请输入合法邮箱" name="email" type="text" autofocus>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <button style="width:180px;height:50px;background:red;color:#fff;font-size:20px;float:left;margin-left:20px;" class="btn-lg btn-default" data-dismiss="modal">退&nbsp;出</button>
                      <button type="submit" style="width:180px;height:50px;float:left;margin-left:20px;" class="btn-lg btn-success">注&nbsp;册</button>

                    <span style="margin-left:20px;"><a href="<?php echo U('Home/Login/index');?>">已有账号,去登录</a></span>
