...
<div style="width:80%;margin:40px auto;height:800px;">
 ...
 if(empty($xj[pic])){ echo '<img src="/Public/Home/Images/touxiang.jpg" width="248px" height="248px" style="border-radius:50%;">'; }else{ echo '<img src="'.$xj[pic].'" width="248px" height="248px" style="border-radius:50%;" >'; } ?>
     ...
     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px;color:#ccc">个人资料</span></div>
       <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px" class="gr"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Personal/change');?>" style="padding:10px 150px 7px 7px">修改密码</a></span></div>
    ...
    <div style="width:700px;float:right;border:1px solid #ccc;font-size:28px;height:50px;line-height:50px">&nbsp;&nbsp;&nbsp;头像修改</div>
   <div style="margin-top:30px">
    <?php if(is_array($users )): foreach($users as $k=>$vo): ?><form class="form-horizontal" action="<?php echo U('Home/Personal/head');?>" method="post">
          <input type="hidden" value="{vo.id}">
          
          <div class="form-group">
          <label class="col-sm-2 control-label">上传头像</label>
               <div class="col-sm-10">
               <?php  if(empty($vo[pic])){ echo '<img src="/Public/Home/Images/touxiang.jpg" width="200px" height="200px">'; }else{ echo '<img src="'.$vo[pic].'" width="200px" height="200px">'; } ?>
                 </div>
          </div>

          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button type="submit" class="btn btn-default" style="color:#000">修改</button>
            </div>
          </div>
   ...
   <div style="width:700px;float:right;border:1px solid #ccc;margin-top:100px">
   <div style="margin-top:20px">
    <?php if(is_array($users )): foreach($users as $k=>$vo): ?><form class="form-horizontal" action="<?php echo U('Home/Personal/revamp');?>" method="post">
          <input type="hidden" value="{vo.id}">
          <div class="form-group">
            <label class="col-sm-2 control-label">用户名</label>
            <div class="col-sm-10">
              <input type="email" name="username" class="form-control" value="<?php echo ($vo["username"]); ?>" disabled>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="radio" name="sex" value=0 <?php if($vo["sex"] == 0): ?>checked<?php endif; ?> disabled>女
              <input type="radio" name="sex" value=1 <?php if($vo["sex"] == 1): ?>checked<?php endif; ?> disabled>男
              <input type="radio" name="sex" value=2 <?php if($vo["sex"] == 2): ?>checked<?php endif; ?> disabled>不详
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">爱好</label>
            <div class="col-sm-10">
              <input type="text" name="hobby[]" value="<?php echo ($vo["hobby"]); ?>" disabled>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">手机号</label>
            <div class="col-sm-10">
              <input type="text" name="tel" class="form-control" value="<?php echo ($vo["tel"]); ?>" disabled>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">邮箱</label>
            <div class="col-sm-10">
              <input type="text" name="email" class="form-control" value="<?php echo ($vo["email"]); ?>" disabled>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">个人简介</label>
            <div class="col-sm-10">
              <textarea name="intro" class="form-control" disabled><?php echo ($vo["intro"]); ?></textarea>
            </div>
          </div>
