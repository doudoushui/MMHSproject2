...
<div class="" style="width:100%;height:60px;background:pink; border:1px solid white;">
  ...
  <h2 style="color:#ff4466;font-size:40px;"><center>/////////////////////////////////////////品牌热销中////////////////////////////////////////</center></h2>
      ...
      <!-- <div class="row" >  -->
        <!-- <?php if(is_array($g)): foreach($g as $k=>$vo): ?><div class="col-sm-6 col-md-3" style="">
            <div class="thumbnail">
...
<div style="width: 100%;height:auto;margin: 0 auto;">
  <li id="item" style="display:none; margin-top:10px;  width: 200px;height: 320px;border:solid 1px #ccc;padding: 10px;text-align:center;">
     <img src="">
      <h3>开心宝贝<?php echo ($g["gname"]); ?></h3>
      <p>价格<?php echo ($g["price"]); ?> <span>200</span></p>
      <p>点赞<?php echo ($g["zan"]); ?> <a>1</a></p>
    </li> 
    <style>
    #ul ul{
      width:300px;
  ...
  var p = 1;//页码信息
  var isLoading = false;
  var url = "<?php echo U('Home/Cate/ajax');?>";
  requestGoods();
  // console.log(p);
    //封装函数发起请求
