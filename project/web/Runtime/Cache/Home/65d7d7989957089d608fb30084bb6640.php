	...
	<div style="width:80%;margin:20px auto;height:800px;">
	  <div style="width:250px;float:left">
       ...
       <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px"><a href="<?php echo U('Home/Order/assess');?>" style="padding:10px 150px 7px 7px">我的评价</a></span></div>
	     ...
	     <div style="width:250px;height:50px;border:1px solid #ccc;line-height:50px;margin-top:20px"><span style="margin-left:10px;font-size:20px;color:#ccc">添加收货地址</span></div>
	     <div style="width:250px;height:500px;border:1px solid #ccc;margin-top:20px">
	       ...
	       <div style="width:220px;height:240px;margin:10px"><img src="/Public/Home/img/1.jpg"></div>
	     </div>
	  </div>

    <div style="width:700px;border:1px solid #ccc;float:right">
       <form class="form-horizontal" action="<?php echo U('Home/Orderaddress/update');?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div style="width:420px;margin:40px auto;">
								<input type="text" id="city"  class="form-control" /><input type="text" name="ad"  class="form-control">
							</div>
            </div>
          </div>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label">是否为默认</label>
            <div class="col-sm-10">
              <input type="radio" name="default" class="form-control" value="0">
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              ...
              <a class="btn btn-default" href="<?php echo U('Home/Orderaddress/index');?>" role="button">关闭</a>
            </div>
          </div>
      </form>
...
<script src="/Public/Home/js/Popt.js"></script>
<script src="/Public/Home/js/cityJson.js"></script>
<script src="/Public/Home/js/citySet.js"></script>
