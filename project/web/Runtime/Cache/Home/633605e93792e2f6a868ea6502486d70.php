...
<div style="width:80%;margin:20px auto;height:800px;">
  <div style="width:250px;float:left">
   ...
   <div style="width:800px;float:right;border:1px solid #ccc">
      ...
      <form class="form-horizontal" action="<?php echo U('Home/Orderaddress/xgl');?>" method="post" enctype="multipart/form-data">
           <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
          <div class="form-group">
            <label class="col-sm-2 control-label">收货人姓名</label>
            <div class="col-sm-10">
              <input type="text" name="oname" class="form-control" value="<?php echo ($info["oname"]); ?>">
            </div>
          </div>
          <div class="form-group">
