...
<div class="container" style="margin-top:30px">
		...
		<form action="<?php echo U('Home/Orderby/insert');?>" method="post">
			<div class="row">
				<table class="table">
					<tr>
			...
			<div class="row">
				<table class="table">
					<div class="form-group">
							...
							<?php
 if(empty($xj[oname])){ echo '<div class="sh"><a href="../Orderaddress/addaddress">+ 添加收货地址</a></div>'; }else if($xj['default'] != 0){ echo '<div class="sh"><a href="../Orderaddress/index"> 选择收货地址</a></div>'; }else{ echo '<div class="col-sm-10">
										 <div class="form-group">
					...
					<tr style="font-size:16px">
						...
						<?php else: ?>
							...
							<?php foreach ($_SESSION['cart'] as $key => $val): ?>
								<tr>
									<td><img src="<?php echo ($val["gpic"]); ?>" width="80px"></td>
