        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
           <?php  if(!empty($_SESSION['username'])){ ?>
            ...
            <?php  }else{ ?>
              <li><a href="<?php echo U('Home/Joke/index');?>"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span>&nbsp;&nbsp;开心一刻</a></li>
            <?php  } ?>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li style="margin-right:10px;"><a href="<?php echo U('Home/Register/index');?>">注册</a></li>
            <li class="dropdown">
          ...
          <ul class="nav navbar-nav navbar-right">
           ...
           <?php  if(empty($pic)){ ?>
            <li class="dropdown">
              ...
              <?php  }else{ ?>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo $pic;?>" style="border-radius:100px;width:35px;">&nbsp;&nbsp;<?php  echo $_SESSION['username']; ?><span class="caret"></span></a>
                <?php  } ?>
...
<!-- <?php echo ($v["gname"]); ?> -->
  <div class="row" > 
    <?php if(is_array($goodss)): foreach($goodss as $k=>$vo): ?><div class="col-sm-6 col-md-3" style="">
        <div class="thumbnail">
          <img src="<?php echo ($vo["gpic"]); ?>" alt="..."style="width:100%;height:200px;">
          <div class="caption sid">
            <h3 style="margin-left:4px;"><?php echo ($vo["gname"]); ?></h3>
            <c>价格:<?php echo ($vo["price"]); ?></c>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="btn-zan" href="<?php echo U('Home/Goods/zan',array('id'=>$vo['id']));?>?zan=<?php echo ($vo["zan"]); ?>"><span class="glyphicon glyphicon-heart" style="color:#ff4466;"></span></a>&nbsp;&nbsp;&nbsp;
            <?php echo ($vo["zan"]); ?><br><br>
            <a href="<?php echo U('Home/Contents/index',array('id'=>$vo['id']));?>"class="btn btn-info" role="button" style="width:150px;margin-left:50px;"><center>查看详情</center></a>&nbsp;&nbsp;&nbsp;
            
          </div>
        </div>
       </div>
      <?php if($k % 4 == 3): ?><div style="clear:both"></div><?php endif; endforeach; endif; ?> 
...
<div style="width: 100%;height:auto;margin: 0 auto;">
  ...
  var p = 1;//页码信息
  var isLoading = false;
  var url = "<?php echo U('Home/Goods/ajaxsearch');?>";
  requestGoods();
  // console.log(p);
    //封装函数发起请求
